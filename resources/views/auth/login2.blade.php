            ...
            <div class="container sm:px-10">
               <div class="block xl:grid grid-cols-2 gap-4">
                  <div class="hidden xl:flex flex-col min-h-screen">
                     <a href="" class="-intro-x flex items-center pt-5"><img alt="Deb" src="{{ asset('frontend/images/logo-top.svg') }}" class="w-6"><span class="text-white text-lg ml-3 font-medium"> Security <span class="font-medium">Resource Management</span></span></a>
                     <div class="my-auto">
