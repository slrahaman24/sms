                ...
                <div class="activities_box">
                  <div class="activeTophead"></div>
                    <div class="activehead" class="col-sm-12">
                            <div class="activities_left_head" >
                                    @if(!empty($res->profile_image))
                                    <img src="{{asset('uploads/image/'.$res->profile_image) }}" class="col_img"/></br>
                                    @else
                                    <img src="{{asset('images/demo_profile.jpg') }}" class="col_img"/></br>
                                    @endif
                            </div>
                    ...
                    <div class="activities_left_box">
                     ...
                     <!-- <span class="auth_sig"> Employee Type : </span>{{$res->emp_type }} <br>  -->
