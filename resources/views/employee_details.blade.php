...
<style>
   ...
   <div class="top-bar">
         <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
            ...
            <a href="" class="breadcrumb--active">Security Personal Details</a>
         </div>
           <?php if(session()->get('per_add') == 1){  ?>
          <div class="intro-x relative mr-3 sm:mr-6">
        <a href="add_employee"><button type="button" class="btn btn-info">
         <span class="glyphicon glyphicon-search"></span>Add Security Personal
        </button></a>
      ...
      <?php }  ?>
        ...
        <div class=" mt-8 card shadow-lg p-3  bg-white rounded h-75">
           <div class=" items-center h-20">
              <h1 class="text-lg font-medium truncate mr-5"> Security Personal Details</h1>
            </div>
